 ...
 * Utility method
*/
void DemoProcessor::computeAttackTime(unsigned long int* peakSampIdx, unsigned long int* attackStartIdx, float* attackTimeValue)
{
    // COMPUTE THE METRICS FOR THE PEAK SAMPLE AND ATTACK TIME
    attackTime.compute(peakSampIdx, attackStartIdx, attackTimeValue);
}
