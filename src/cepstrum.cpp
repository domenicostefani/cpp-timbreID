...
Cepstrum<SampleType>::Cepstrum - header between Juce and the TimbreID cepstrum~ module
...
*/
template <typename SampleType>
Cepstrum<SampleType>::Cepstrum(unsigned long int analysisWindowSize)
{
...
/** Free memory used */
template <typename SampleType>
Cepstrum<SampleType>::~Cepstrum() { freeMem(); }
...
*/
template <typename SampleType>
void Cepstrum<SampleType>::prepare (unsigned long int sampleRate, unsigned int blockSize) noexcept
{
...
*/
template <typename SampleType>
void Cepstrum<SampleType>::reset() noexcept
{
...
*/
template <typename SampleType>
std::vector<float>& Cepstrum<SampleType>::compute()
{
...
*/
template <typename SampleType>
void Cepstrum<SampleType>::setWindowFunction(tIDLib::WindowFunctionType func) noexcept
{
...
*/
template <typename SampleType>
void Cepstrum<SampleType>::setSpectrumType(tIDLib::SpectrumType spec) noexcept
{
...
*/
template <typename SampleType>
void Cepstrum<SampleType>::setCepstrumType(tIDLib::CepstrumType ceps) noexcept
{
...
*/
template <typename SampleType>
void Cepstrum<SampleType>::setSpectrumOffset(bool offset)
{
...
*/
template <typename SampleType>
void Cepstrum<SampleType>::setWindowSize(uint32_t windowSize)
{
...
*/
template <typename SampleType>
unsigned long int Cepstrum<SampleType>::getWindowSize() const noexcept
{
...
*/
template <typename SampleType>
std::string Cepstrum<SampleType>::getInfoString() const noexcept
{
    std::string res = "";
...
*/
template <typename SampleType>
void Cepstrum<SampleType>::storeAudioBlock(const SampleType* input, size_t n) noexcept
{
...
*/
template <typename SampleType>
void Cepstrum<SampleType>::initModule()
{
...
*/
template <typename SampleType>
void Cepstrum<SampleType>::freeMem()
{
    // free FFTW stuff
    fftwf_free(this->fftwOut);
    fftwf_destroy_plan(this->fftwForwardPlan);
...
template class Cepstrum<float>;
template class Cepstrum<double>;
