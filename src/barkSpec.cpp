...
*/
template <typename SampleType>
BarkSpec<SampleType>::BarkSpec(unsigned long int analysisWindowSize)
{
...
*/
template <typename SampleType>
BarkSpec<SampleType>::BarkSpec(unsigned long int analysisWindowSize, float barkSpacing)
{
    if (analysisWindowSize < tIDLib::MINWINDOWSIZE)
        throw std::invalid_argument("Window size must be "+std::to_string(tIDLib::MINWINDOWSIZE)+" or greater.");
...
/** Free memory used */
template <typename SampleType>
BarkSpec<SampleType>::~BarkSpec() { freeMem(); }
...
*/
template <typename SampleType>
void BarkSpec<SampleType>::prepare (unsigned long int sampleRate, unsigned int blockSize) noexcept
{
...
*/
template <typename SampleType>
void BarkSpec<SampleType>::reset() noexcept
{
...
*/
template <typename SampleType>
void BarkSpec<SampleType>::createFilterbank(float barkSpacing)
{
    if (barkSpacing < tIDLib::MINBARKSPACING || barkSpacing > tIDLib::MAXBARKSPACING)
        throw std::invalid_argument("Bark spacing must be between "+std::to_string(tIDLib::MINBARKSPACING)+" and "+std::to_string(tIDLib::MAXBARKSPACING)+" Barks");
...
*/
template <typename SampleType>
std::vector<float>& BarkSpec<SampleType>::compute()
{
...
*/
template <typename SampleType>
void BarkSpec<SampleType>::setWindowFunction(tIDLib::WindowFunctionType func) noexcept
{
...
*/
template <typename SampleType>
void BarkSpec<SampleType>::setFiltering(tIDLib::FilterState state) noexcept
{
...
*/
template <typename SampleType>
void BarkSpec<SampleType>::setFilterOperation(tIDLib::FilterOperation operationType) noexcept
{
...
*/
template <typename SampleType>
void BarkSpec<SampleType>::setSpectrumType(tIDLib::SpectrumType spec) noexcept
{
...
*/
template <typename SampleType>
void BarkSpec<SampleType>::setWindowSize(uint32_t windowSize)
{
...
*/
template <typename SampleType>
void BarkSpec<SampleType>::setNormalize(bool norm) noexcept
{
    this->normalize = norm;
}
...
*/
template <typename SampleType>
unsigned long int BarkSpec<SampleType>:: getWindowSize() const noexcept
{
...
*/
template <typename SampleType>
bool BarkSpec<SampleType>:: getNormalize() const noexcept
{
...
template <typename SampleType>
std::string BarkSpec<SampleType>:: getFilterFreqsInfo() const noexcept
{
    std::string res = "";
...
*/
template <typename SampleType>
std::string BarkSpec<SampleType>:: getInfoString() const
{
    std::string res = "";
...
*/
template <typename SampleType>
std::string BarkSpec<SampleType>:: getHatString(float filt) const noexcept
{
    t_filterIdx idx;
    std::string res = "";
...
*/
template <typename SampleType>
void BarkSpec<SampleType>::initModule()
{
...
*/
template <typename SampleType>
void BarkSpec<SampleType>::storeAudioBlock(const SampleType* input, size_t n) noexcept
{
...
*/
template <typename SampleType>
void BarkSpec<SampleType>::freeMem()
{
    fftwf_free(this->fftwOut);
    fftwf_destroy_plan(this->fftwPlan);
}

template class BarkSpec<float>;
template class BarkSpec<double>;
