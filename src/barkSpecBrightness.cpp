...
BarkSpecBrightness<SampleType>::BarkSpecBrightness()
{
...
*/
template <typename SampleType>
BarkSpecBrightness<SampleType>::BarkSpecBrightness(unsigned long int analysisWindowSize)
{
...
*/
template <typename SampleType>
BarkSpecBrightness<SampleType>::BarkSpecBrightness(unsigned long int analysisWindowSize, float barkSpacing)
{
    if(analysisWindowSize < tIDLib::MINWINDOWSIZE)
        throw std::invalid_argument("Window size must be "+std::to_string(tIDLib::MINWINDOWSIZE)+" or greater.");
...
*/
template <typename SampleType>
BarkSpecBrightness<SampleType>::BarkSpecBrightness(unsigned long int analysisWindowSize, float barkSpacing, float barkBoundary)
{
    if(analysisWindowSize < tIDLib::MINWINDOWSIZE)
        throw std::invalid_argument("Window size must be "+std::to_string(tIDLib::MINWINDOWSIZE)+" or greater.");
    if(barkSpacing < tIDLib::MINBARKSPACING || barkSpacing > tIDLib::MAXBARKSPACING)
...
/** Free memory used */
template <typename SampleType>
BarkSpecBrightness<SampleType>::~BarkSpecBrightness(){ freeMem(); }
...
*/
template <typename SampleType>
void BarkSpecBrightness<SampleType>::prepare (unsigned long int sampleRate, unsigned int blockSize) noexcept
{
...
*/
template <typename SampleType>
void BarkSpecBrightness<SampleType>::reset() noexcept
{
...
*/
template <typename SampleType>
void BarkSpecBrightness<SampleType>::createFilterbank(float barkSpacing)
{
    if(barkSpacing < tIDLib::MINBARKSPACING || barkSpacing > tIDLib::MAXBARKSPACING)
        throw std::invalid_argument("Bark spacing must be between "+std::to_string(tIDLib::MINBARKSPACING)+" and "+std::to_string(tIDLib::MAXBARKSPACING)+" Barks");
...
*/
template <typename SampleType>
float BarkSpecBrightness<SampleType>::compute()
{
...
*/
template <typename SampleType>
void BarkSpecBrightness<SampleType>::setWindowFunction(tIDLib::WindowFunctionType func)
{
...
*/
template <typename SampleType>
void BarkSpecBrightness<SampleType>::setSpectrumType(tIDLib::SpectrumType spec)
{
...
*/
template <typename SampleType>
void BarkSpecBrightness<SampleType>::setFiltering(tIDLib::FilterState state)
{
...
*/
template <typename SampleType>
void BarkSpecBrightness<SampleType>::setFilterOperation(tIDLib::FilterOperation operationType)
{
...
*/
template <typename SampleType>
void BarkSpecBrightness<SampleType>::setWindowSize(uint32_t windowSize)
{
...
*/
template <typename SampleType>
unsigned long int BarkSpecBrightness<SampleType>::getWindowSize() const noexcept
{
...
*/
template <typename SampleType>
std::string BarkSpecBrightness<SampleType>::getInfoString()
{
    std::string res = "";
...
*/
template <typename SampleType>
void BarkSpecBrightness<SampleType>::setBoundary(float barkBoundary)
{
    if(barkBoundary > tIDLib::MAXBARKS || barkBoundary < 0)
...
*/
template <typename SampleType>
float BarkSpecBrightness<SampleType>::getBoundary()
{
...
*/
template <typename SampleType>
void BarkSpecBrightness<SampleType>::initModule()
{
...
*/
template <typename SampleType>
void BarkSpecBrightness<SampleType>::storeAudioBlock(const SampleType* input, size_t n) noexcept
{
...
*/
template <typename SampleType>
void BarkSpecBrightness<SampleType>::freeMem()
{
    // free FFTW stuff
    fftwf_free(this->fftwOut);
    fftwf_destroy_plan(this->fftwPlan);
...
template class tid::BarkSpecBrightness<float>;
template class tid::BarkSpecBrightness<double>;
